    ...
    <Page actionBarHidden="true">
        <FlexboxLayout class="page">
            <StackLayout class="form">
                <Image class="logo" src="~/images/Render.png"></Image>
                <Label class="header" text="AMC ФТК"></Label>
                ...
                <Button :text="isLoggingIn ? 'Войти' : 'Регистрация'"
                    :isEnabled="!processing" @tap="submit"
                    class="btn btn-primary m-t-20"></Button>
                <Label *v-show="isLoggingIn" text="Забыли свой пароль?"
            ...
            <Label class="login-label sign-up-label" @tap="toggleForm">
                <FormattedString>
                    <Span
                        :text="isLoggingIn ? 'У меня нет учетки? ' : 'Вернуться к авторизации'">
                    </Span>
                    <Span :text="isLoggingIn ? 'Регистрация' : ''"
                        class="bold">
                    </Span>
                </FormattedString>
            </Label>
